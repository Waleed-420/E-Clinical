...
class _UserAppointmentsState extends State<UserAppointments> {
  ...
  Future<void> fetchAppointments() async {
    try {
      final response = await http.get(
        Uri.parse(
          'http://192.168.10.19:5000/api/user/${widget.user['_id']}/appointments',
        ),
      );
  ...
  Future<void> initiateVideoCall(Map<String, dynamic> appointment) async {
    final res = await http.post(
      Uri.parse('http://192.168.10.19:5000/api/start-call'),
  ...
  void _showPrescriptionDialog(
    ...
    Future<void> _save() async {
      ...
      try {
        final res = await http.post(
          Uri.parse(
            'http://192.168.10.19:5000/api/appointments/${appointment['_id']}/prescription',
          ),
          headers: {'Content-Type': 'application/json'},
                  ...
                  : () async {
                      ...
                      try {
                        final response = await http.post(
                          Uri.parse(
                            'http://192.168.10.19:5000/api/appointments/$appointmentId/rate',
                          ),
                          headers: {'Content-Type': 'application/json'},
